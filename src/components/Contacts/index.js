                  ...
                  <div className='contacts-container'>
                    <div className='contacts-delivery-time'>
                        <div className='delivery-time'>
                            <span>2</span><span>мин</span>
                            <p>из центра Киева</p>
                        </div>
                        <div className='delivery-time'>
                            <span>12</span><span>мин</span>
                            <p>из центра Днепра</p>
                        </div>
                        <div className='delivery-time'>
                            <span>42</span><span>мин</span>
                            <p>из центра Харькова</p>
                        </div>
                        <div className='delivery-time'>
                            <span>52</span><span>мин</span>
                       ...
                       <div className='more-contacts'>
                          <div className='wrap'>
                              <div className='details'>
                                  <img src="/img/contacts/mark.png" alt="mark"/><span>Киев, улица Шевченка 42</span>
                              </div>
                              <div className='details'>
                                  <img src="/img/contacts/phone.png" alt="mark"/><span>+38(067)-231-23-24</span>
                              </div>
